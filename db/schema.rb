...
ActiveRecord::Schema.define(version: 20_200_905_132_633) do
  ...
  create_table 'add_action_to_notifications', force: :cascade do |t|
    t.string 'action'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  end
  ...
  create_table 'remove_action_from_notifications', force: :cascade do |t|
    t.integer 'action'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  end
